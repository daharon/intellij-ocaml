        ...
        val expected = Completions(
            entries = listOf(
                ...
                CompletionEntry(
                    ...
                    kind = "Value",
                    desc = "f:(int -> 'a -> 'b) -> 'a list -> 'b list",
                    info = ""
                ),
                CompletionEntry(
                    name = "ListLabels.map2",
                    kind = "Value",
                    desc = "f:('a -> 'b -> 'c) -> 'a list -> 'b list -> 'c list",
                    info = ""
                ),
                CompletionEntry(
                    name = "ListLabels.map",
                    kind = "Value",
                    desc = "f:('a -> 'b) -> 'a list -> 'b list",
                    info = ""
                )
            ).reversed(),
            context = null
...
//    }
    ...
    private fun merlinInstance(): MerlinProtocol2 {
        return MerlinProtocol2.newInstance()
    }
}